...
zqry1.SQL.Clear;
zqry1.SQL.Add('Update orang_tua set Nama_orangtua = "'+e_1.Text+'",Telp="'+e_2.Text+'",Pendidikan_terakhir="'+e_3.Text+'",Pekerjaan="'+e_4.Text+'", Nik_nomorKTP ="'+ e_5.Text +'", Alamat_orgtua = "' + e_6.Text + '", Status_orgtua = "' + cbb3.Text + '" where Id_orgtua = "' + id + '"');
zqry1. ExecSQL;
